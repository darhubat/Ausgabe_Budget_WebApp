...
def speichern(datei, key, value):
    try:
        with open(datei) as open_file:
            datei_inhalt = json.load(open_file)  # laden json, erhalten ein Dictionary
    ...
    with open(datei, "w") as open_file:
        json.dump(datei_inhalt, open_file)  # speichern mit json.dump, mit indent=2 können noch Abstände ergänzt werden
